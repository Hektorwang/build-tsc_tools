...
_arg_check_env="on"
_arg_config_selinux="off"
_arg_config_runlevel="off"
_arg_config_services="off"
_arg_config_timezone="off"
_arg_timezone="Asia/Shanghai"
_arg_disable_firewall="off"
_arg_config_ssh="off"
_arg_sshd_port=
_arg_ntp_server=
_arg_config_user_env="off"
_arg_config_system_parameter="off"
_arg_install_fhmv="off"
_arg_all="off"
...
print_help()
{
	...
	printf 'Usage: %s [--(no-)check_env] [--(no-)config_selinux] [--(no-)config_runlevel] [--(no-)config_services] [--(no-)config_timezone] [--timezone <arg>] [--(no-)disable_firewall] [--(no-)config_ssh] [--sshd_port <arg>] [--ntp_server <arg>] [--(no-)config_user_env] [--(no-)config_system_parameter] [--(no-)install_fhmv] [--(no-)all] [-h|--help]\n' "$0"
	printf '\t%s\n' "--check_env, --no-check_env: Check running environment (on by default)"
	printf '\t%s\n' "--config_selinux, --no-config_selinux: Disable SELinux (off by default)"
	printf '\t%s\n' "--config_runlevel, --no-config_runlevel: Set runlevel to multi-user.target (off by default)"
	printf '\t%s\n' "--config_services, --no-config_services: Disable non-core services (off by default)"
	printf '\t%s\n' "--config_timezone, --no-config_timezone: Configure system timezone. default: Asia/Shanghai (off by default)"
	printf '\t%s\n' "--timezone: Specify timezone (e.g., Asia/Tokyo) (default: 'Asia/Shanghai')"
	printf '\t%s\n' "--disable_firewall, --no-disable_firewall: Disable firewall service and clear rules (off by default)"
	printf '\t%s\n' "--config_ssh, --no-config_ssh: Configure ssh service and client (off by default)"
	printf '\t%s\n' "--sshd_port: Configure ssh service listen port (e.g., 2222) (no default)"
	printf '\t%s\n' "--ntp_server: Configure ntp server (e.g., time.windows.com) (no default)"
	printf '\t%s\n' "--config_user_env, --no-config_user_env: Configure bashrc (off by default)"
	printf '\t%s\n' "--config_system_parameter, --no-config_system_parameter: Configure system parameter (off by default)"
	printf '\t%s\n' "--install_fhmv, --no-install_fhmv: Install fh-data-recovery(fhmv) (off by default)"
	printf '\t%s\n' "--all, --no-all: Configure all settings (off by default)"
	printf '\t%s\n' "-h, --help: Prints help"
}
...
parse_commandline()
{
	...
	do
		_key="$1"
		case "$_key" in
			--no-check_env|--check_env)
				_arg_check_env="on"
				test "${1:0:5}" = "--no-" && _arg_check_env="off"
				;;
			--no-config_selinux|--config_selinux)
				_arg_config_selinux="on"
				test "${1:0:5}" = "--no-" && _arg_config_selinux="off"
				;;
			--no-config_runlevel|--config_runlevel)
				_arg_config_runlevel="on"
				test "${1:0:5}" = "--no-" && _arg_config_runlevel="off"
				;;
			--no-config_services|--config_services)
				_arg_config_services="on"
				test "${1:0:5}" = "--no-" && _arg_config_services="off"
				;;
			--no-config_timezone|--config_timezone)
				_arg_config_timezone="on"
				test "${1:0:5}" = "--no-" && _arg_config_timezone="off"
				;;
			--timezone)
			...
			--timezone=*)
				...
				;;
			--no-disable_firewall|--disable_firewall)
				_arg_disable_firewall="on"
				test "${1:0:5}" = "--no-" && _arg_disable_firewall="off"
				;;
			--no-config_ssh|--config_ssh)
				_arg_config_ssh="on"
				test "${1:0:5}" = "--no-" && _arg_config_ssh="off"
				;;
			--sshd_port)
				test $# -lt 2 && die "Missing value for the optional argument '$_key'." 1
				_arg_sshd_port="$2"
			...
			--ntp_server)
				...
				;;
			--ntp_server=*)
				_arg_ntp_server="${_key##--ntp_server=}"
				;;
			--no-config_user_env|--config_user_env)
				_arg_config_user_env="on"
				test "${1:0:5}" = "--no-" && _arg_config_user_env="off"
				;;
			--no-config_system_parameter|--config_system_parameter)
				_arg_config_system_parameter="on"
				test "${1:0:5}" = "--no-" && _arg_config_system_parameter="off"
				;;
			--no-install_fhmv|--install_fhmv)
				_arg_install_fhmv="on"
				test "${1:0:5}" = "--no-" && _arg_install_fhmv="off"
				;;
			--no-all|--all)
				_arg_all="on"
